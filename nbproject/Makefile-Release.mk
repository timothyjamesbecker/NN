...
${OBJECTDIR}/c11timer.o: nbproject/Makefile-${CND_CONF}.mk c11timer.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/c11timer.o c11timer.cpp
...
${OBJECTDIR}/nn2.o: nbproject/Makefile-${CND_CONF}.mk nn2.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/nn2.o nn2.cpp
...
${OBJECTDIR}/c11timer_nomain.o: ${OBJECTDIR}/c11timer.o c11timer.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/c11timer_nomain.o c11timer.cpp;\
	else  \
...
${OBJECTDIR}/nn2_nomain.o: ${OBJECTDIR}/nn2.o nn2.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/nn2_nomain.o nn2.cpp;\
	else  \
