...
${OBJECTDIR}/c11timer.o: nbproject/Makefile-${CND_CONF}.mk c11timer.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -w -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/c11timer.o c11timer.cpp
...
${OBJECTDIR}/nn.o: nbproject/Makefile-${CND_CONF}.mk nn.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -w -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/nn.o nn.cpp

${OBJECTDIR}/nn2.o: nbproject/Makefile-${CND_CONF}.mk nn2.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -w -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/nn2.o nn2.cpp

${OBJECTDIR}/sb.o: nbproject/Makefile-${CND_CONF}.mk sb.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -w -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/sb.o sb.cpp
...
${TESTDIR}/tests/NN_Test.o: tests/NN_Test.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -w -I. -std=c++11 -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/NN_Test.o tests/NN_Test.cpp
...
${OBJECTDIR}/c11timer_nomain.o: ${OBJECTDIR}/c11timer.o c11timer.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -w -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/c11timer_nomain.o c11timer.cpp;\
	else  \
...
${OBJECTDIR}/main_nomain.o: ${OBJECTDIR}/main.o main.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -w -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/main_nomain.o main.cpp;\
	else  \
...
${OBJECTDIR}/nn_nomain.o: ${OBJECTDIR}/nn.o nn.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -w -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/nn_nomain.o nn.cpp;\
	else  \
...
${OBJECTDIR}/nn2_nomain.o: ${OBJECTDIR}/nn2.o nn2.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -w -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/nn2_nomain.o nn2.cpp;\
	else  \
...
${OBJECTDIR}/sb_nomain.o: ${OBJECTDIR}/sb.o sb.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -w -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/sb_nomain.o sb.cpp;\
	else  \
